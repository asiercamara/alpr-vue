---
title: 'ALPR Vue: License Plate Recognition in Your Browser'
description: 'ALPR Vue detects and reads vehicle license plates in your browser — live camera, photo, or video. No server, no account, and fully private.'
---
...
<VTDocCard title="Camera Mode" icon="camera" href="./camera-mode">

Use your webcam or phone camera to detect plates in real time with live bounding boxes.

</VTDocCard>

<VTDocCard title="Upload Files" icon="upload" href="./upload-files">

Upload a photo or video to extract all license plates without a live camera.

</VTDocCard>

<VTDocCard title="Export Data" icon="file-csv" href="./exporting-data">
