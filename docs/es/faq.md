...
<VTDocAccordionGroup>
<VTDocAccordion title="¿Funciona ALPR Vue sin conexión?">
...
<VTDocAccordion title="¿Mis imágenes o la imagen de la cámara se suben a algún lugar?">
...
<VTDocAccordion title="¿Qué formatos de matrícula son compatibles?">
...
<VTDocAccordion title="¿Puedo usarlo en el móvil?">
...
<VTDocAccordion title="¿Por qué la aplicación detiene la cámara automáticamente?">
...
<VTDocAccordion title="¿Puedo leer matrículas de fotos o vídeos que ya tengo?">
...
<VTDocAccordion title="¿Por qué la puntuación de confianza es baja para algunos caracteres?">
...
<VTDocAccordion title="¿Qué hace 'Omitir duplicados'?">
...
<VTDocAccordion title="¿Hay una aplicación móvil nativa?">
...
<VTDocAccordion title="¿Puedo alojar ALPR Vue yo mismo?">
