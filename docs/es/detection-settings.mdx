...
<AccordionGroup>
  ...
  <Accordion title="Modo continuo (predeterminado: activado)">
    ...
    Cuando el modo continuo está **desactivado**, la cámara se detiene automáticamente en cuanto se confirma la primera matrícula. Esto es útil para flujos de trabajo de captura de una sola matrícula — por ejemplo, registrar manualmente vehículos uno a uno en un puesto de control — donde quieres revisar cada matrícula antes de continuar.
  ...
  <Accordion title="Omitir duplicados (predeterminado: activado)">
    Cuando omitir duplicados está **activado**, cualquier matrícula cuyo texto ya aparece en tu historial de detecciones actual se ignora silenciosamente. Esto mantiene tu historial limpio cuando el mismo vehículo permanece a la vista durante un período prolongado.

    Desactívalo si necesitas registrar cada evento de detección independientemente de si esa matrícula ya se ha visto antes — por ejemplo, al registrar los tiempos de entrada y salida del mismo vehículo.
  </Accordion>
